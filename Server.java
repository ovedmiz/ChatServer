...
import il.co.ilrd.chatserver.ChatServerMessage.ChatProtocolKeys;
...
import il.co.ilrd.pingpong.handlers.ServerMessage.ProtocolType;
...
public class Server {
	...
	private class ChatServerProtocol implements Protocol {
		...
		private final static String NOT_REGISTRED = "you are not registred.";
		private final static String INVALID_KEY = "Invalid key.";
		private final static String INVALID_CONNECTION = "Invalid connction.";
		...
		private void registrationHandle(InfoAboutConnection clientInfo, 
			...
			if(chatMessage.getKey().equals(ChatProtocolKeys.REGISTRATION_REQUEST)) {
				...
				sendErrorMessage(clientInfo, chatMessage, NOT_REGISTRED);
			}
		}
		...
		private void sendErrorMessage(InfoAboutConnection clientInfo, 
					ChatServerMessage chatMessage, String reasonOfError) 
										throws IOException {
			setChatMessage(chatMessage, ChatProtocolKeys.ERROR_MESSAGE, 
											reasonOfError);			
